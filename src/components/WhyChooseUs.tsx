...
export default function WhyChooseUs() {
  ...
  return (
    <section id="why-us" className="section-shell theme-section-light" aria-labelledby="why-title">
      <div className="absolute right-0 bottom-1/4 w-96 h-96 bg-brand-tan/8 rounded-full blur-3xl pointer-events-none" aria-hidden="true" />
      ...
      <div className="container max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-14 md:mb-16">
          ...
          <h2 id="why-title" className="font-serif text-3xl sm:text-4xl lg:text-5xl font-semibold leading-tight text-slate-950 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(320px,_auto)]">
          ...
          <motion.div
            whileHover={{ y: -4 }}
            className="glass-effect md:col-span-2 rounded-3xl p-6 sm:p-8 flex flex-col justify-between border-slate-200/80 shadow-md group relative overflow-hidden"
          >
            <div>
              <div className="flex items-center justify-between gap-4 mb-6">
                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-teal/10 text-brand-teal border border-brand-teal/10">
                  <Layers size={20} />
                </span>
            ...
            <div className="mt-8 border-t border-slate-200/80 pt-6">
              <div className="grid grid-cols-3 gap-4 relative">
                ...
                {[
                  { year: "2002 - 2019", title: "Enterprise Tech", detail: "Presales Architecture Depth", accent: "border-brand-teal bg-brand-teal/15 text-brand-teal" },
                  { year: "2019 - 2024", title: "Sales Leader", detail: "ServiceNow, OutSystems, SFDC", accent: "border-brand-rust bg-brand-rust/15 text-brand-rust" },
                  { year: "2024 - Pres.", title: "GTM Advisory", detail: "Accelerating Market Entry", accent: "border-brand-tan bg-brand-tan/15 text-brand-rust" }
                ].map((step, sIdx) => (
          ...
          <motion.div
            whileHover={{ y: -4 }}
            className="glass-effect rounded-3xl p-6 sm:p-8 flex flex-col justify-between border-slate-200/80 shadow-md group relative overflow-hidden bg-gradient-to-br from-white to-slate-50/50"
          >
            <div>
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-rust/10 text-brand-rust border border-brand-rust/10 mb-6">
                <Award size={20} />
              </div>
            ...
            <div className="mt-8 flex flex-wrap gap-2">
              {['ServiceNow', 'Salesforce', 'OutSystems'].map(brand => (
                <span key={brand} className="px-3 py-1.5 rounded-lg text-xs font-semibold bg-white border border-slate-200 text-slate-700 shadow-sm flex items-center gap-1.5">
          ...
          <motion.div
            whileHover={{ y: -4 }}
            className="glass-effect md:row-span-2 rounded-3xl p-6 sm:p-8 flex flex-col border-slate-200/80 shadow-md group relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-64 h-64 bg-brand-tan/10 rounded-full blur-3xl -mr-20 -mt-20 pointer-events-none" />
            
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-tan/10 text-brand-tan border border-brand-tan/10 mb-6">
              <MapPin size={20} />
            </div>
            ...
            <div className="mt-auto pt-8 flex-1 flex flex-col justify-end">
              <div className="relative h-48 w-full rounded-2xl border border-slate-200 bg-slate-50/50 overflow-hidden flex items-center justify-center">
                {/* Node map simulation */}
          ...
          <motion.div
            whileHover={{ y: -4 }}
            className="glass-effect md:col-span-2 rounded-3xl p-6 sm:p-8 flex flex-col md:flex-row gap-8 border-slate-200/80 shadow-md group relative overflow-hidden bg-gradient-to-r from-white to-slate-50"
          >
            <div className="flex-1">
              <div className="flex items-center justify-between gap-4 mb-6">
                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-slate-100 text-slate-800 border border-slate-200">
                  <BarChart3 size={20} />
                </span>
            ...
            <div className="flex-1 flex flex-col justify-center bg-white rounded-2xl border border-slate-100 p-5 shadow-inner">
              <div className="flex flex-col h-full relative">
                ...
                <div className="py-3 flex items-center justify-center relative">
                  ...
                  <div className="absolute bg-white px-2 text-brand-teal">
          ...
          <motion.div
            whileHover={{ y: -4 }}
            className="glass-effect rounded-3xl p-6 sm:p-8 flex flex-col justify-between border-slate-200/80 shadow-md group relative overflow-hidden bg-brand-teal/10"
          >
            <div>
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-green/10 text-brand-green border border-brand-green/10 mb-6">
                <Sparkles size={20} />
              </div>
              <h3 className="text-xl font-black tracking-tight text-slate-900 group-hover:text-brand-green transition-colors duration-300">
            ...
            <div className="mt-8 flex items-center justify-between border-t border-brand-teal/10 pt-4">
          ...
          <motion.div
            whileHover={{ y: -4 }}
            className="glass-effect rounded-3xl p-6 sm:p-8 flex flex-col justify-between border-slate-200/80 shadow-md group relative overflow-hidden bg-gradient-to-br from-white to-slate-50"
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-brand-teal/20 rounded-full blur-3xl -mr-10 -mt-10 pointer-events-none" />
            
            <div>
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-teal/10 text-brand-teal border border-brand-teal/15 mb-6">
                <ShieldAlert size={20} />
              </div>
              <h3 className="text-xl font-black tracking-tight text-slate-900 transition-colors duration-300">
                100% GTM Velocity
              </h3>
              <p className="mt-3 text-sm leading-relaxed text-slate-600">

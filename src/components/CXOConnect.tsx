...
const themeClasses = {
  teal: {
    ...
    bgGradient: "from-white to-brand-teal/3",
    shadow: "shadow-brand-teal/5",
    text: "text-brand-teal",
    tagActive: "border-brand-teal/25 bg-brand-teal/4 text-brand-teal",
    routePill: "bg-brand-teal/10 text-brand-teal border border-brand-teal/20 shadow-[0_0_12px_rgba(16,155,130,0.12)]",
    cardBg: "border-brand-teal bg-gradient-to-br from-white/95 to-brand-teal/[0.08]",
  ...
  green: {
    ...
    bgGradient: "from-white to-brand-green/3",
    shadow: "shadow-brand-green/5",
    text: "text-brand-green",
    tagActive: "border-brand-green/25 bg-brand-green/4 text-brand-green",
    routePill: "bg-brand-green/10 text-brand-green border border-brand-green/20 shadow-[0_0_12px_rgba(79,143,123,0.12)]",
    cardBg: "border-brand-green bg-gradient-to-br from-white/95 to-brand-green/[0.08]",
  ...
  warm: {
    ...
    bgGradient: "from-white to-brand-rust/3",
    shadow: "shadow-brand-rust/5",
    text: "text-brand-rust",
    tagActive: "border-brand-rust/25 bg-brand-rust/4 text-brand-rust",
    routePill: "bg-brand-rust/10 text-brand-rust border border-brand-rust/20 shadow-[0_0_12px_rgba(184,90,58,0.12)]",
    cardBg: "border-brand-rust bg-gradient-to-br from-white/95 to-brand-rust/[0.08]",
...
export default function CXOConnect() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-1/3 h-72 w-72 rounded-full bg-brand-teal/8 blur-3xl" aria-hidden="true" />
      ...
      <div className="container relative z-10 mx-auto max-w-7xl px-6 sm:px-8">
        <div className="mx-auto mb-14 max-w-3xl text-center md:mb-16">
          ...
          <h2 id="cxo-title" className="mb-4 font-serif text-3xl font-semibold leading-tight text-slate-950 sm:text-4xl lg:text-5xl">
        ...
        <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12 lg:gap-12">
            ...
            {networks.map((net, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-lg font-extrabold text-slate-950 transition-colors duration-300">{net.title}</h3>
                  <p className={`mt-1 text-xs font-bold uppercase tracking-wide transition-colors duration-300 ${netTheme.text}`}>{net.subtitle}</p>
                  <p className="mt-3 text-sm leading-relaxed text-slate-600">{net.description}</p>
          ...
          <div className="order-1 lg:order-2 lg:col-span-7">
            <div className="premium-card relative min-h-[520px] overflow-hidden rounded-2xl p-4 sm:p-7">
              ...
              <div className="absolute left-1/2 top-1/2 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full border border-slate-200/80" aria-hidden="true" />
              ...
              <div className="relative h-[466px] w-full">
                ...
                >
                  ...
                  <path d="M 50 50 C 56 25, 66 25, 72 50" fill="none" stroke={activeSegment === 1 ? themeClasses.green.glowColor : "rgba(148,163,184,0.08)"} strokeWidth={activeSegment === 1 ? "6" : "2"} vectorEffect="non-scaling-stroke" filter={activeSegment === 1 ? "url(#laser-glow)" : undefined} className="transition-all duration-300" />
                  <path d="M 50 50 C 56 25, 66 25, 72 50" fill="none" stroke={activeSegment === 1 ? themeClasses.green.laser : "rgba(148,163,184,0.25)"} strokeWidth={activeSegment === 1 ? "2" : "1.2"} vectorEffect="non-scaling-stroke" strokeDasharray={activeSegment === 1 ? "8 8" : "4 4"} className={`${activeSegment === 1 ? "animate-flow-dash-fast" : ""} transition-all duration-300`} />
                ...
                <div className="relative z-10 flex h-full items-center justify-between gap-4">
                  <motion.div
                    whileHover={{ y: -4 }}
                    className="glass-effect w-[26%] min-w-0 rounded-2xl p-4 text-center border-slate-200/80"
                  >
                    <span className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-950 text-white">
                      <Cpu size={22} />
                    </span>
                    <p className="text-sm font-extrabold text-slate-950">Global Product Company</p>
                    <p className="mt-2 text-xs leading-relaxed text-slate-500">SaaS, AI, automation, and enterprise software teams seeking India growth.</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-base font-black uppercase tracking-wide text-slate-950">VALUEAGES</p>
                    ...
                    <p className="mt-3 text-xs leading-relaxed text-slate-600">Qualifies the account thesis, maps stakeholders, and coordinates executive motion.</p>
                  </motion.div>
              ...
              <div className="glass-effect relative z-20 mt-2 rounded-2xl p-4 border-slate-200/80 shadow-lg">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-extrabold text-slate-950">Active path: {active.title}</p>
                      <p className="text-xs text-slate-500">Client thesis &rarr; VALUEAGES qualification &rarr; executive introduction.</p>
                    </div>
                  </div>
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 px-3 py-1.5 text-[10px] font-bold uppercase tracking-wide text-emerald-600">

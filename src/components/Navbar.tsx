  ...
  return (
    <>
      ...
      >
        ...
        <div className={`mx-auto flex items-center justify-between transition-all duration-500 w-full ${
          isScrolledDeep ? "max-w-4xl px-2 sm:px-4" : isScrolled ? "max-w-6xl px-4 sm:px-6" : "max-w-7xl px-4 sm:px-6 lg:px-8"
        }`}>
            ...
            <Image
              ...
              className={`h-10 w-auto sm:h-11 shrink-0 transition-all duration-500 ease-in-out group-hover:scale-105 dark-invert ${
                isScrolledDeep
                  ...
                  : "max-w-[9rem] sm:max-w-[12rem] lg:max-w-[14rem] opacity-100"
              }`}
              loading="eager"
              style={{ width: "auto" }}
            />
          ...
          <div className="lg:hidden flex items-center gap-1">
            <motion.button
              ...
              className="relative flex items-center justify-center text-slate-600 hover:text-brand-teal transition-colors duration-200 rounded-xl hover:bg-brand-teal/8 active:bg-brand-teal/12 p-2.5 min-w-11 min-h-11"
              whileTap={{ scale: 0.92 }}
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            key="mobile-overlay"
            className="fixed inset-0 top-0 mobile-overlay lg:hidden z-[60]"
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed top-0 right-0 bottom-0 w-[320px] max-w-[88vw] mobile-glass border-l border-slate-200/50 z-[70] shadow-2xl flex flex-col lg:hidden"
            ...
            >
              ...
              <div className="mt-3 flex flex-col gap-1.5">
                <a
                  ...
                  className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl border border-slate-200/60 bg-slate-50/50 hover:border-brand-teal/30 hover:bg-brand-teal/5 transition-all duration-200 group min-h-11"
                >
                  <Phone size={14} className="text-brand-teal flex-shrink-0 transition-transform group-hover:scale-110" />
                ...
                <a
                  ...
                  className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl border border-slate-200/60 bg-slate-50/50 hover:border-brand-teal/30 hover:bg-brand-teal/5 transition-all duration-200 group min-h-11"
                >
                  <Mail size={14} className="text-brand-teal flex-shrink-0 transition-transform group-hover:scale-110" />
